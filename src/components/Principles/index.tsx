  ...
  useEffect(() => {
    const fetchImageUrl = async () => {
      try {
        ...
        const response = await fetch(`${backendUrl}/images/Home.svg`, {
          headers: {
          ...
          <div className={styles.aboutUsExamples}>
            <div className={styles.frame394}>
              <div className={styles.frame60}>
                ...
                <h3 className={styles.benefitTitle}>
                  {t("broadSelectionTitle")}
                </h3>
                <p className={styles.benefitText}>{t("broadSelectionText")}</p>
              </div>
              <div className={styles.frame59}>
                ...
                />
                <h3 className={styles.benefitTitle}>
                  {t("customerTrustTitle")}
                </h3>
                <p className={styles.benefitText}>{t("customerTrustText")}</p>
              </div>
              <div className={styles.frame62}>
                ...
                <p className={styles.benefitText}>{t("reliabilityText")}</p>
              </div>
            </div>
            <div className={styles.frame395}>
              <div className={styles.frame61}>
                ...
                <p className={styles.benefitText}>{t("easeOfUseText")}</p>
              </div>
              ...
              <div className={styles.frame57}>
                ...
                <p className={styles.benefitText}>{t("secureDealsText")}</p>
              </div>
            </div>
          </div>
        </div>
